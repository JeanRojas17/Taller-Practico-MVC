...
public class VistaDocenteSwing extends JPanel {
    ...
    private void mostrarDialogoRegistro() {
        ...
        JTextField especialidad = new JTextField(20);
        ...
        if(opcion == JOptionPane.YES_OPTION) {
            ...
            txtEspecialidad.setText(especialidad.getText().trim());
    ...
    private void mostrarDialogoActualizar() {
        ...
        if(idSeleccionado < 0) {
            mostrarError("Selecciona un docente para modificar.");
            return;
        }
        ...
        String especialidad = String.valueOf(modeloTabla.getValueAt(fila, 2));

        JTextField nombreField = new JTextField(nombre, 20);
        JTextField especialidadField = new JTextField(especialidad, 20);
        ...
        if(opcion == JOptionPane.YES_OPTION) {
            ...
            txtEspecialidad.setText(especialidadField.getText().trim());
