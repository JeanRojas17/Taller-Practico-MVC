...
public class VistaEstudianteSwing extends JPanel {
    ...
    private java.util.List<Estudiante> todosDatos = new ArrayList<>();
    ...
    private void mostrarPaginaActual() {
        ...
        for(int i = desde; i < hasta; i++) {
            Estudiante item = todosDatos.get(i);
            modeloTabla.addRow(new Object[]{item.getId(), item.getNombre(), item.getApellido(), item.getEmail()});
        }
    ...
    public void cargarEstudiantes(List<Estudiante> datos) {
