...
public class VistaMateriaSwing extends JPanel {
    ...
    private java.util.List<Materia> todosDatos = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        tabla.getColumnModel().getColumn(2).setCellRenderer(rendererIzq);
    ...
    private JPanel buildPanelEncabezado() {
        JLabel lblTitulo = new JLabel("Gestion de Materias");
        lblTitulo.setFont(new Font("SansSerif", Font.BOLD, 22));
        lblTitulo.setForeground(new Color(30, 70, 130));

        JLabel lblSubtitulo = new JLabel("Administra el registro, actualizacion y eliminacion de materias");
    ...
    private void mostrarDialogoRegistro() {
        ...
        JTextField creditos = new JTextField(20);
    ...
    private void mostrarDialogoActualizar() {
        ...
        String creditos = String.valueOf(modeloTabla.getValueAt(fila, 2));

        JTextField nombreField = new JTextField(nombre, 20);
        JTextField creditosField = new JTextField(creditos, 20);

        JPanel panel = new JPanel(new GridLayout(0, 1, 6, 6));
        panel.add(new JLabel("Nombre:"));
        panel.add(nombreField);
        panel.add(new JLabel("Creditos:"));
        panel.add(creditosField);
    ...
    private void mostrarPaginaActual() {
        ...
        for(int i = desde; i < hasta; i++) {
            Materia item = todosDatos.get(i);
            modeloTabla.addRow(new Object[]{item.getId(), item.getNombreMateria(), item.getCreditos()});
        }
    ...
    public void cargarMaterias(List<Materia> datos) {
